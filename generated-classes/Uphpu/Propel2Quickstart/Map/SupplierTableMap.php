...
use Uphpu\Propel2Quickstart\Supplier;
...
class SupplierTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Uphpu.Propel2Quickstart.Map.SupplierTableMap';
     ...
     */
    const OM_CLASS = '\\Uphpu\\Propel2Quickstart\\Supplier';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Uphpu.Propel2Quickstart.Supplier';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Snum', 'Name', 'Status', 'City', ),
        self::TYPE_CAMELNAME     => array('snum', 'name', 'status', 'city', ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_SNUM, SupplierTableMap::COL_NAME, SupplierTableMap::COL_STATUS, SupplierTableMap::COL_CITY, ),
        self::TYPE_FIELDNAME     => array('snum', 'name', 'status', 'city', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Snum' => 0, 'Name' => 1, 'Status' => 2, 'City' => 3, ),
        self::TYPE_CAMELNAME     => array('snum' => 0, 'name' => 1, 'status' => 2, 'city' => 3, ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_SNUM => 0, SupplierTableMap::COL_NAME => 1, SupplierTableMap::COL_STATUS => 2, SupplierTableMap::COL_CITY => 3, ),
        self::TYPE_FIELDNAME     => array('snum' => 0, 'name' => 1, 'status' => 2, 'city' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Uphpu\\Propel2Quickstart\\Supplier');
        $this->setPackage('Uphpu.Propel2Quickstart');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('snum', 'Snum', 'CHAR', true, 5, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Snum', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SupplierTableMap::COL_SNUM);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Uphpu\Propel2Quickstart\Supplier) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(SupplierTableMap::DATABASE_NAME);
            $criteria->add(SupplierTableMap::COL_SNUM, (array) $values, Criteria::IN);
        }
