...
use Uphpu\Propel2Quickstart\Category;
use Uphpu\Propel2Quickstart\CategoryQuery;
...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Uphpu.Propel2Quickstart.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Uphpu\\Propel2Quickstart\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Uphpu.Propel2Quickstart.Category';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'TreeLeft', 'TreeRight', 'TreeLevel', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'treeLeft', 'treeRight', 'treeLevel', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_TITLE, CategoryTableMap::COL_TREE_LEFT, CategoryTableMap::COL_TREE_RIGHT, CategoryTableMap::COL_TREE_LEVEL, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'tree_left', 'tree_right', 'tree_level', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'TreeLeft' => 2, 'TreeRight' => 3, 'TreeLevel' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'treeLeft' => 2, 'treeRight' => 3, 'treeLevel' => 4, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_TITLE => 1, CategoryTableMap::COL_TREE_LEFT => 2, CategoryTableMap::COL_TREE_RIGHT => 3, CategoryTableMap::COL_TREE_LEVEL => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'tree_left' => 2, 'tree_right' => 3, 'tree_level' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Uphpu\\Propel2Quickstart\\Category');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Uphpu\Propel2Quickstart\Category) { // it's a model object
