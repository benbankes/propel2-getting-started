...
abstract class Job implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Uphpu\\Propel2Quickstart\\Map\\JobTableMap';
    ...
    /**
     * Initializes internal state of Uphpu\Propel2Quickstart\Base\Job object.
     */
     ...
     * @return $this|\Uphpu\Propel2Quickstart\Job The current object (for fluent API support)
     */
    public function setJnum($v)
    {
        ...
        if ($this->jnum !== $v) {
            $this->jnum = $v;
            $this->modifiedColumns[JobTableMap::COL_JNUM] = true;
        }
    ...
    /**
     * Set the value of [jname] column.
     *
     * @param string $v new value
     * @return $this|\Uphpu\Propel2Quickstart\Job The current object (for fluent API support)
     */
    public function setJname($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->jname !== $v) {
            $this->jname = $v;
            $this->modifiedColumns[JobTableMap::COL_JNAME] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[JobTableMap::COL_CITY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : JobTableMap::translateFieldName('Jnum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->jnum = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : JobTableMap::translateFieldName('Jname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->jname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : JobTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = JobTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Uphpu\\Propel2Quickstart\\Job'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(JobTableMap::COL_JNUM)) {
            $modifiedColumns[':p' . $index++]  = 'jnum';
        }
        if ($this->isColumnModified(JobTableMap::COL_JNAME)) {
            $modifiedColumns[':p' . $index++]  = 'jname';
        }
        if ($this->isColumnModified(JobTableMap::COL_CITY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'jnum':
                        ...
                        break;
                    case 'jname':
                        $stmt->bindValue($identifier, $this->jname, PDO::PARAM_STR);
                        break;
                    case 'city':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Uphpu\Propel2Quickstart\Job
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setJnum($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setJname($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Uphpu\Propel2Quickstart\Job The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobTableMap::COL_JNUM)) {
            $criteria->add(JobTableMap::COL_JNUM, $this->jnum);
        }
        if ($this->isColumnModified(JobTableMap::COL_JNAME)) {
            $criteria->add(JobTableMap::COL_JNAME, $this->jname);
        }
        if ($this->isColumnModified(JobTableMap::COL_CITY)) {
            $criteria->add(JobTableMap::COL_CITY, $this->city);
        }
    ...
    /**
     * Generic method to set the primary key (jnum column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Uphpu\Propel2Quickstart\Job (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setJname($this->getJname());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Uphpu\Propel2Quickstart\Job Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSupplierProductJobs(Collection $supplierProductJobs, ConnectionInterface $con = null)
    {
        ...
        foreach ($supplierProductJobsToDelete as $supplierProductJobRemoved) {
            $supplierProductJobRemoved->setJob(null);
        }
    ...
    protected function doAddSupplierProductJob(ChildSupplierProductJob $supplierProductJob)
    {
        ...
        $supplierProductJob->setJob($this);
    }
    ...
    public function removeSupplierProductJob(ChildSupplierProductJob $supplierProductJob)
    {
        if ($this->getSupplierProductJobs()->contains($supplierProductJob)) {
            ...
            $supplierProductJob->setJob(null);
        }
