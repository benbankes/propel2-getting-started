...
abstract class Product implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Uphpu\\Propel2Quickstart\\Map\\ProductTableMap';
    ...
    /**
     * Initializes internal state of Uphpu\Propel2Quickstart\Base\Product object.
     */
     ...
     * @return $this|\Uphpu\Propel2Quickstart\Product The current object (for fluent API support)
     */
    public function setPnum($v)
    {
        ...
        if ($this->pnum !== $v) {
            $this->pnum = $v;
            $this->modifiedColumns[ProductTableMap::COL_PNUM] = true;
        }
    ...
    public function setColor($v)
    {
        ...
        if ($this->color !== $v) {
            $this->color = $v;
            $this->modifiedColumns[ProductTableMap::COL_COLOR] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[ProductTableMap::COL_CITY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductTableMap::translateFieldName('Pnum', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductTableMap::translateFieldName('Color', TableMap::TYPE_PHPNAME, $indexType)];
            $this->color = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('Weight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Uphpu\\Propel2Quickstart\\Product'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Uphpu\Propel2Quickstart\Product
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Uphpu\Propel2Quickstart\Product The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_PNUM)) {
            $criteria->add(ProductTableMap::COL_PNUM, $this->pnum);
        }
        if ($this->isColumnModified(ProductTableMap::COL_NAME)) {
            $criteria->add(ProductTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProductTableMap::COL_COLOR)) {
            $criteria->add(ProductTableMap::COL_COLOR, $this->color);
        }
        if ($this->isColumnModified(ProductTableMap::COL_WEIGHT)) {
            $criteria->add(ProductTableMap::COL_WEIGHT, $this->weight);
        }
        if ($this->isColumnModified(ProductTableMap::COL_CITY)) {
            $criteria->add(ProductTableMap::COL_CITY, $this->city);
        }
    ...
    /**
     * Generic method to set the primary key (pnum column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Uphpu\Propel2Quickstart\Product (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Uphpu\Propel2Quickstart\Product Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSupplierProducts(Collection $supplierProducts, ConnectionInterface $con = null)
    {
        ...
        foreach ($supplierProductsToDelete as $supplierProductRemoved) {
            $supplierProductRemoved->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildSupplierProduct[] List of ChildSupplierProduct objects
     */
    public function getSupplierProductsJoinSupplier(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSupplierProductQuery::create(null, $criteria);
    ...
    public function setSupplierProductJobs(Collection $supplierProductJobs, ConnectionInterface $con = null)
    {
        ...
        foreach ($supplierProductJobsToDelete as $supplierProductJobRemoved) {
            $supplierProductJobRemoved->setProduct(null);
        }
    ...
    protected function doAddSupplierProductJob(ChildSupplierProductJob $supplierProductJob)
    {
        ...
        $supplierProductJob->setProduct($this);
    }
    ...
    public function removeSupplierProductJob(ChildSupplierProductJob $supplierProductJob)
    {
        if ($this->getSupplierProductJobs()->contains($supplierProductJob)) {
            ...
            $supplierProductJob->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildSupplierProductJob[] List of ChildSupplierProductJob objects
     */
    public function getSupplierProductJobsJoinSupplier(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSupplierProductJobQuery::create(null, $criteria);
        $query->joinWith('Supplier', $joinBehavior);
